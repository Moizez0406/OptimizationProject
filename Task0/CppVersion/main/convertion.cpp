...
int main() {
  ...
  std::ofstream convergenceFile("../main/results/convergence_ga_"+instance_path+".csv");
  ...
  std::ofstream summaryFile("../main/results/convergence_summary_"+instance_path+".txt");
  ...
  std::cout << "\nConvergence data saved to convergence_ga_"<<instance_path<<".csv\n";
  std::cout << "Summary saved to convergence_summary_"<<instance_path<<".txt\n";
