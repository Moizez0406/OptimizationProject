...
int main() {
  ...
  std::ofstream csvFile("../main/results/Comparison_"+instance_path+".csv");
  csvFile
  ...
  std::ofstream bestFile("../main/results/"+instance_path+".txt");
  ...
  std::cout << "\nResults saved to:\n";
  std::cout << "  - results/BestSequenceComparion_"<< instance_path<<".csv<<(Raw data)\n";
  std::cout
    << "  - results/best_sequences"<< instance_path<<".txt (Best sequences and "
    "statistics)\n";
