...
pm_summary = pd.read_csv("../results/pm_summary_tai20_5_0.csv")
...
px_summary = pd.read_csv("../results/px_summary_tai20_5_0.csv")
...
pop_summary = pd.read_csv("../results/population_summary_tai20_5_0.csv")
...
tour_summary = pd.read_csv("../results/tournament_summary_tai20_5_0.csv")
