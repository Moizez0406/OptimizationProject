...
int main() {
    ...
    std::ofstream pmSummary("../main/results/pm_summary_" + instance_path +
                            ".csv");
    ...
    std::ofstream pxFile("../main/results/px_analysis_" + instance_path +
                         ".csv");
    pxFile << "px,run,makespan\n";

    std::ofstream pxSummary("../home/results/px_summary_" + instance_path +
                            ".csv");
    ...
    std::ofstream popFile("../main/results/population_analysis_" +
                          instance_path + ".csv");
    popFile << "population_size,run,makespan\n";

    std::ofstream popSummary("../main/results/population_summary_" +
                             instance_path + ".csv");
    ...
    std::ofstream tourFile("results/tournament_analysis_" + instance_path +
                           ".csv");
    tourFile << "tournament_size,run,makespan\n";

    std::ofstream tourSummary("results/tournament_summary_" + instance_path +
                              ".csv");
